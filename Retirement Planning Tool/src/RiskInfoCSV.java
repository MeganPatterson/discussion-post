...
public class RiskInfoCSV {
	...
	// this method reads in the riskAllocations file
	public static void RiskLevelReader () {
		RiskLevel riskReader = new RiskLevel ("riskAllocations.csv");
		ArrayList <String> riskLevel = riskReader.getLevel();
